    ...
    <main className="pt-20 p-4 max-w-7xl mx-auto min-h-screen">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="space-y-4 opacity-90">
          ...
          <div className="space-y-4 opacity-90 mt-2">
          <p className="text-justify">
          ...
          <ul className="list-disc ml-10 mt-2">
            <li className="opacity-100 mb-2"><div className="opacity-90"><u><div className="font-bold mb-2">Co-Chair of student club</div></u> I am the co-chair of the health vertical in <a href= "https://youngindians.net/yuva/" className="text-blue-500" target="_blank">YUVA Young Indians</a>
              , a student club that focuses on national development in fields such as Health, Road safety, Child safety, etc.</div></li>
            
            <li className="opacity-100 mb-2"><div className="opacity-90"><u><div className="font-bold mb-2">Documentation Head</div></u> I was the head of documentation for <a href="https://drestein.in/" target="_blank" className="text-blue-500">Drestein'24</a>
            ...
            <li className="opacity-100 mb-2"><div className="opacity-90"><u><div className="font-bold mb-2">Event Organizing</div></u> I was one of the organizers of the Inauguration week 2024
            ...
            <li className="opacity-100 mb-2"><div className="opacity-90"><u><div className="font-bold mb-2">Member of the content team</div></u> I am currently a member of the
